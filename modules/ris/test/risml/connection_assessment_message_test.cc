...
char const* connection_assessment_fixture_1 = R"(
...
TEST(DISABLED_ris_connection_assessment_message, message_1) {
  ...
  auto const messages = parse.parse(connection_assessment_fixture_1);
...
char const* connection_assessment_fixture_2 = R"(
<?xml version="1.0" encoding="iso-8859-1" ?>
...
TEST(DISABLED_ris_connection_assessment_message, message_2) {
  ris::risml::risml_parser parse{};
  auto const messages = parse.parse(connection_assessment_fixture_2);
  ASSERT_EQ(1, messages.size());
