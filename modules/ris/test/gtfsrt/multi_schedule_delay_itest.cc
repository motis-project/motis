...
namespace sbb = motis::test::schedule::gtfs_minimal_swiss;
namespace poznan = motis::test::schedule::gtfs_minimal_poznan;
...
auto const gtfsrt_multi_schedule_dataset_opt =
...
struct ris_gtfsrt_multi_schedule_delay_message_itest_t0 : public gtfsrt_itest {
  ris_gtfsrt_multi_schedule_delay_message_itest_t0()
      : gtfsrt_itest(
            gtfsrt_multi_schedule_dataset_opt,
...
struct ris_gtfsrt_multi_schedule_delay_message_itest_t1 : public gtfsrt_itest {
  ris_gtfsrt_multi_schedule_delay_message_itest_t1()
      : gtfsrt_itest(
            gtfsrt_multi_schedule_dataset_opt,
