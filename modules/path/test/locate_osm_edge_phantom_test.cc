...
TEST(locate_osm_edge_phantom_with_dist, lueneburg) {
  geo::latlng const north{53.2510503, 10.4198096};  // north
  geo::latlng const south{53.2484046, 10.4197946};  // south
  geo::latlng const station_pos{53.249700, 10.419106};  // western / middle
...
TEST(locate_osm_edge_phantom_with_dist, hamburg) {
  geo::latlng const north{53.5530362, 10.0058828};  // north
  geo::latlng const south{53.5525599, 10.0061187};  // south
  geo::latlng const station_pos{53.552736, 10.006909};  // eastern / northern
