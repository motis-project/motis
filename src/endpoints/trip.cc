...
api::Itinerary trip::operator()(boost::urls::url_view const& url) const {
  ...
  return journey_to_response(
      ...
      tt_location{to_l.get_location_idx()}, cache, &blocked, 0U,
      transfer_routing_profiles_t{}, query.joinInterlinedLegs_, false, false,
      query.withScheduledSkippedStops_, 0.0, 0.0, api_version, false, false,
      query.language_);
}
