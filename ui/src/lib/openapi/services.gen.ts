 ...
 *
 */
export const railviz = <ThrowOnError extends boolean = false>(options: Options<RailvizData, ThrowOnError>) => { return (options?.client ?? client).get<RailvizResponse, RailvizError, ThrowOnError>({
    ...options,
    url: '/api/v1/railviz'
}); };
