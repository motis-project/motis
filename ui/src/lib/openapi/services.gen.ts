 ...
 * @param data.fromPlace latitude, longitude, level pair in degrees or stop id
 * @param data.toPlace latitude, longitude, level pair in degrees or stop id
 ...
 * @param data.mode A comma separated list of modes.
 *
