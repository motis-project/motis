 ...
 */
export const stopRoutes = <ThrowOnError extends boolean = false>(options?: Options<StopRoutesData, ThrowOnError>) => {
    return (options?.client ?? client).get<StopRoutesResponse, StopRoutesError, ThrowOnError>({
        ...options,
        url: '/api/v1/stop/routes'
    });
};
