            ...
            <div className='connection-details trip-view'>
                <div className='connection-info'>
                    <div className='header'>
                        <div className='back'><i className='icon' onClick={() => {props.setTrainSelected(undefined); window.portEvents.pub('mapSetDetailFilter', props.mapFilter); props.setSubOverlayHidden(true)}}>arrow_back</i></div>
