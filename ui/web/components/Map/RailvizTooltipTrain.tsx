    ...
    return (
        <>
            ...
            <div className='departure'>
                ...
                <div className={`time ${train.hasDepartureDelayInfo ? 'delay' : 'no-delay-infos'}`}>{/** muss in abhaengikeit von train gesetzt werden */}
            ...
            <span className='station'>{train.arrivalStation}</span>
                <div className={`time ${train.hasArrivalDelayInfo ? 'delay' : 'no-delay-infos'}`}>{/** muss in abhaengikeit von train gesetzt werden */}
