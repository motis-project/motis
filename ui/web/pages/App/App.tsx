...
declare global {
    interface Window {
        app: GlobalParameters;
        elmMaps: mapboxgl.Map[];
    }
}
...
export const App: React.FC = () => {
    ...
    React.useEffect(() => {    
        (function bootstrap() {
            ...
            initPorts(window.app, apiEndpoint, tilesEndpoint, initialPermalink);
            handleDrop(document.getElementById("app-container"));
            window.app.ports.localStorageSet.subscribe(function (kv) {
        ...
        function handleDrop(element) {
            ...
            function onLoad(i) {
                ...
                if (--remaining == 0) {
                    ...
                    window.app.ports.setRoutingResponses.send(data);
                }
                };
            }
