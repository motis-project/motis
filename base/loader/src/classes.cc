...
mcd::hash_map<mcd::string, service_class> const& class_mapping() {
  static auto const mapping = mcd::hash_map<mcd::string, service_class>{
      // planes
      ...
      {"Metropolitan", service_class::S},

      // subway
      {"Subway", service_class::U},
      {"U", service_class::U},
      {"STB", service_class::U},
      ...
      {"Trolleybus", service_class::BUS},
      {"Scoala", service_class::BUS},
