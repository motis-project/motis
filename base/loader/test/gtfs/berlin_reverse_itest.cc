...
struct loader_graph_builder_gtfs_berlin_reverse : public motis_instance_test {
  explicit loader_graph_builder_gtfs_berlin_reverse()
      : motis_instance_test(
            loader_options{.dataset_ = {(gtfs::SCHEDULES / "berlin_reverse")
                                            .generic_string()},
                           .dataset_prefix_ = {"x"},
    ...
    fbb.create_and_finish(
        ...
        routing::CreateRoutingRequest(
            ...
            routing::CreateInputStation(
                ...
                fbb.CreateString("")),
            routing::SearchType_Default, SearchDir_Backward,
...
TEST_F(loader_graph_builder_gtfs_berlin_reverse, search) {
  auto const& s = sched();
  ...
  auto res = routing_query("de:11000:900140002::2", "de:11000:900132011::2",
                           "2023-04-15 02:00 Europe/Berlin");
