...
struct loader_graph_builder_gtfs_berlin_block_id : public motis_instance_test {
  explicit loader_graph_builder_gtfs_berlin_block_id()
      : motis_instance_test(
            loader_options{.dataset_ = {(gtfs::SCHEDULES / "berlin_block_id")
                                            .generic_string()},
                           .dataset_prefix_ = {"x"},
...
TEST_F(loader_graph_builder_gtfs_berlin_block_id, search_s1_s8) {
  auto res = routing_query("de:11000:900040102::2", "de:11000:900058157::2",
                           "2023-04-15 02:37 Europe/Berlin");
