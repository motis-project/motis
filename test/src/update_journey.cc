...
void create_free_text_msg(FlatBufferBuilder& fbb, std::string const& eva_num,
  ...
  // clang-format on
  fbb.Finish(CreateRISMessage(
      fbb, 0, 0, 0, RISMessageUnion_FreeTextMessage,
...
msg_ptr get_free_text_ris_msg(std::string const& eva_num, int const service_num,
  ...
  message_creator mc;
  std::vector<Offset<RISMessageHolder>> const messages{CreateRISMessageHolder(
      mc,
...
void create_station_event_time_change_msg(
  ...
  fbb.Finish(CreateRISMessage(
      fbb, 0, 0, 0, RISMessageUnion_DelayMessage,
...
void create_canceled_train_msg(
  ...
  // clang-format on
  fbb.Finish(CreateRISMessage(
      fbb, 0, 0, 0, RISMessageUnion_CancelMessage,
...
void create_track_msg(FlatBufferBuilder& fbb, std::string const& eva_num,
  ...
  // clang-format on
  fbb.Finish(CreateRISMessage(
      fbb, 0, 0, 0, RISMessageUnion_TrackMessage,
